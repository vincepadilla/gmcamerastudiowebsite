...
new Swiper('.card-wrapper', {
    ...
    //For services
    function redirectToFilter(filter) {
        window.location.href = `./Services/services.html?filter=${filter}`; // Redirect with filter ID
        window.open(targetUrl, '_blank'); //change the window.location.href to const targetUrl if you want other tabs
    }
